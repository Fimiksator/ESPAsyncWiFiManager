...
const char HTTP_STAND_ALONE_OPTIONS[] PROGMEM = "<form action=\"/api/v2/wifi/stand_alone_yes\" method=\"get\"><button>Activate</button></form><br/><form action=\"/api/v2/wifi/stand_alone_no\" method=\"get\"><button>Dectivate</button></form>";
const char HTTP_STAND_ALONE_OPTIONS_STA[] PROGMEM = "<form action=\"/api/v2/wifi/stand_alone_yes\" method=\"get\"><button>Activate</button></form><br/><form action=\"/api/v2/wifi/stand_alone_no\" method=\"get\"><button>Dectivate</button></form>";
